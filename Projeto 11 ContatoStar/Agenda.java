...
class SchedulePlus extends Schedule{
    ...
    public boolean bookmarkContact(String name){
        if(super.getContacts().containsKey(name)){
            if(!this.bookmarks.containsKey(name)){
                bookmarks.put(name, super.getContacts().get(name));
                return true;
            }
    ...
    public String toString(){
        ...
        for(Contact contacts : super.getContacts().values()){
            if(!this.bookmarks.containsKey(contacts.getName())){
                response += "- " + contacts + "\n";
            }
        }
        return response;
